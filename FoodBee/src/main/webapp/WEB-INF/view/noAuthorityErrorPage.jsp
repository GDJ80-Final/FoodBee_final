                    ...
                    <div class="error-content">
                        <div class="card mb-0">
                            <div class="card-body text-center pt-5">
                                ...
                                <h4 class="mt-4"><i class="fa fa-thumbs-down text-danger"></i> 권한 없음</h4>
                                <p>접속 권한이 존재하지 않습니다.</p>
                                <form class="mt-5 mb-5">
                                    
                                    <div class="text-center mb-4 mt-4"><a href="${pageContext.request.contextPath}/home" class="btn btn-primary">메인보드로 이동</a>
                                    </div>
                                </form>
