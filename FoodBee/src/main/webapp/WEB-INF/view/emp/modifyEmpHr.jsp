...
<head>
<meta charset="UTF-8">
<title>FoodBee : 사원 인사 정보 수정</title>
	  	...
	  	<div class="row page-titles mx-0">
		  	<div class="col p-md-0">
	            <ol class="breadcrumb">
	                ...
	                <li class="breadcrumb-item active"><a href="javascript:void(0)">사원 수정</a></li>
	            </ol>
	        </div>
        </div>
	    <div class="container-fluid">
        	<div class="row">
                  <div class="col-lg-12">
                      <div class="card">
                          <div class="card-body">
                          	<a href="${pageContext.request.contextPath}/emp/empDetail?empNo=${empHr.empNo}" class="btn btn-primary btn-block" id="back">돌아가기</a>
                       		<div class="row">
	                          	<div class="col"></div>
	                       		<div class="col-8">
