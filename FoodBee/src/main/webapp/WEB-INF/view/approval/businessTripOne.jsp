...
<head>
<meta charset="UTF-8">
<title>FoodBee : 출장신청서 상세보기</title>
						...
						<div class="form-section">        
							<div class="form-group">
								...
								<div class="form-group">
								    ...
								    <textarea id="content" rows="14" cols="50" name="content" placeholder="출장 목적을 작성하세요." readonly="readonly">${businessTripOne.content}</textarea>
								</div>            
						      ...
						      <!-- 반려사유 확인버튼 -->
						      	<c:if test="${businessTripOne.docApproverState == 9 && (businessTripOne.midApproverReason != null || businessTripOne.finalApproverReason != null)}">
